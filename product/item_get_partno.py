...
def lambda_handler(event, context):
    ...
    cursor.execute("SELECT io_size, io_size_origin, io_part_no, io_pr, io_max_weight, io_speed, io_car, io_oe, io_car_type, io_tire_type, io_factory_price, io_maker, it_name, it_pattern, it_season, it_performance_type, tot_stock, io_btob_price as io_price, io_discontinued FROM   "
                   ...
                   "WHERE  category.ca_id IS NOT NULL AND item.it_id IS NOT NULL and sale_delivery >= opt.io_btob_lowest ")
    connection.commit()

...
def lambda_handler(event, context):
    ...
    return_list = {"od_name": order_info[0], "od_tel": order_info[1], "od_zip": order_info[2], "od_addr1": order_info[3], "od_addr2": order_info[4], "od_addr3": order_info[5], "od_memo": order_info[6], "od_receipt_price": order_info[7], "od_ip": order_info[8], "od_time": order_info[9], 'cart_item': []}
    ...
    for row in rows:
        cart_list = {}
        cart_list['io_part_no'] = row[0]
        return_list['cart_item'] = cart_list

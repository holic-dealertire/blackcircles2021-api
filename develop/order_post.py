    ...
    if od_id:
        ...
        if row_count != 0:
            ...
            for i in range(length):
                ...
                input_tot_delivery_price = input_it_sc_price * input_ct_qty
                ...
                cursor.execute("""select sale_delivery, delivery_price from tbl_item_option_price_stock where mb_no = %s and io_no = %s""", (input_seller_no, io_no))
                connection.commit()
